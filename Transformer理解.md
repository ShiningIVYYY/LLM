...
- **词嵌入（Word Embedding）**
	transformer的开头，只需要知道它把一个词变成一个多维的向量，在transformer中一般是512维a_i\in R^{512}(a_i指单词)这个维度被称为“**d_{model}**”
...
![alt text](file:///d%3A/APP/Wechat/xwechat_files/wxid_aqinnc4jcdzj12_0ea7/temp/RWTemp/2025-10/9e20f478899dc29eb19741386f9343c8/9d1187d3adb325929f174f8c19efaa72.png)
...
$$
\text{Attention}(Q, K, V)
= \underbrace{\text{softmax}\!\left(\frac{QK^{T}}{\sqrt{d_k}} + M\right)}_{\text{apply mask before softmax}} V
$$
---
...
3. 公式：$x_{l} = \mathrm{block}(x_{l-1}) + x_{l-1}$这里的$block$可以是$attention$或者$Feedforward$
